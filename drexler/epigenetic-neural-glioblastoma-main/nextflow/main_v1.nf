...
/*
 * Nanopore Neural Glioblastoma Classification Pipeline
 ...
 * using the neural signature score with threshold 0.41
 */
...
log.info """
=========================================
Nanopore Neural Glioblastoma Classification
=========================================
...
process CLASSIFY_SAMPLE {
    ...
    script:
    """
    python ${params.script_dir}/run_nanopore_classification.py \\
        ${bedmethyl_file} \\
...
process AGGREGATE_RESULTS {
    ...
    for pred_file in glob.glob("*_prediction.csv"):
        ...
        for sample_id, row in df.iterrows():
            all_results.append({
                'sample_id': sample_id,
                'Neural_Signature_Score': round(row['Neural_Signature_Score'], 4),
